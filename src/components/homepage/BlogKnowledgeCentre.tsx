...
const BlogKnowledgeCentre: React.FC = () => <section className="py-16 px-4 md:px-8 bg-gradient-to-b from-amber-50 to-white" id="blog-knowledge">
    <div className="container mx-auto max-w-6xl">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {articles.map((article, idx) => <Link key={article.to} to={article.to} className="block p-5 bg-white rounded-lg border shadow-sm hover:shadow-md transition animate-fade-in" style={{
