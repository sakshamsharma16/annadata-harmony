  ...
  return (
    <main className="py-16 px-4 min-h-screen bg-gradient-to-b from-white to-amber-50">
      <div className="max-w-2xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold mb-2">Consumer Testimonials</h2>
          <div className="space-y-5">
            <div className="bg-white border rounded-xl p-4 flex items-center gap-3">
              <Star className="text-yellow-400" /><span className="font-medium">“Everything is so fresh, and prices are always fair. I love chatting with the vendor carts!”</span>
            </div>
            <div className="bg-white border rounded-xl p-4 flex items-center gap-3">
              <Star className="text-yellow-400" /><span className="font-medium">“No more morning rush for vegetables—now they come to my gate. Kids love it too!”</span>
            </div>
            <div className="bg-white border rounded-xl p-4 flex items-center gap-3">
              <Star className="text-yellow-400" /><span className="font-medium">“It feels good to buy directly from farmers and see their stories on the Annadata platform.”</span>
            </div>
          </div>
        </section>
      </div>
