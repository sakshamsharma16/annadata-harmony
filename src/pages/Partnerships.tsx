      ...
      <div className="max-w-2xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            Partner with us to take Annadata and Krishi Mitra to every farm and doorstep in India.
          </p>
        </section>
        ...
        <div className="bg-gradient-to-r from-[#FF9933]/10 to-[#138808]/10 border px-6 py-5 mt-8 rounded-lg text-center">
